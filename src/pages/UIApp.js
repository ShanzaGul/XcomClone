                    ...
                    <Row className="uiapp-card">
                        <Col md={12} lg={4}>
                            <Card className="p-5" style={{ backgroundColor: "#34086b" }}  >
                                <Card.Img variant="top" src={img1} style={{ width: "100%", height: "170px" }} />
                                <Card.Body>
                        ...
                        <Col md={12} lg={4} >
                            <Card className="p-5  card-margin-top mt-md-5 mt-lg-0" style={{ backgroundColor: "#34086b" }}  >
                                <Card.Img variant="top" src={img2} style={{ width: "100%", height: "170px" }} />
                                <Card.Body>
                        ...
                        <Col md={12} lg={4}>
                            <Card className="p-5 card-margin-top mt-md-5 mt-lg-0" style={{ backgroundColor: "#34086b" }}   >
                                <Card.Img variant="top" src={img3} style={{ width: "100%", height: "170px" }} />
                                <Card.Body>
                ...
                <Row style={{ paddingTop: "7%", color: "white" }} className="justify-content-center">
                    <Col sm={12} md={6}>
                        <div style={{ height: "auto", maxWidth: "100%" }}>
                            <img data-aos="fade-up" src={img4} alt="img for ui and app" style={{ maxWidth: "100%", height: "auto" }}></img>
                        </div>
                    </Col>
