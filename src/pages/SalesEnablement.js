                    ...
                    <Row className="sales-card">
                        <Col className="p-0">
                            ...
                            <Row className="content-tabs m-0">
                                <Col>
                                    <Row className={toggleState === 1 ? "content  active-content" : "content"}>
                                        <Col md={12} lg={8} className={toggleState === 1 ? "noanimate" : ""}>
                                        <div className="p-md-5 p-sm-2">
                                            <h2>Allowing organizations to help clients envision their end products</h2>
                                        ...
                                        <Col className={toggleState === 1 ? "animate" : ""}>
                                            <img src={img1} alt="img for sales">
                                            </img>
                                        </Col>

                                    </Row>

                                    <Row className={toggleState === 2 ? "content  active-content" : "content"}>
                                        <Col  className={toggleState === 2 ? "noanimate" : ""}>
                                            <img src={img3}  alt="img for sales">
                                            </img>
                                        </Col>
                                        <Col md={12} lg={8}  className={toggleState === 2 ? "animate" : ""}>
                                        <div className="p-md-5 p-sm-2">
                                            <h2>Allowing organizations to help clients envision their end products</h2>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
                                    ...
                                    <Row className={toggleState === 3 ? "content  active-content" : "content"}>

                                        <Col md={12} lg={8} className={toggleState === 3 ? "noanimate" : ""}>
                                        <div className="p-md-5 p-sm-2">
                                        <h2>Allowing organizations to help clients envision their end products</h2>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
                                        ...
                                        <Col className={toggleState === 3 ? "animate" : ""}>
                                            <img src={img2}  alt="img for sales">
                                            </img>
                                        </Col>
                                    </Row>
                                </Col>
