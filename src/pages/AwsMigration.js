                ...
                <Col xs={12}>
                    <Row className="aws-card">
                        <Col className="bg-orange aws-card-img " md={6} sm={12} xs={12}>
                            <img src={awshome}  data-aos="fade-up" alt="aws-migration" className="imgaws"></img>
                        </Col>
                        <Col md={6} sm={12} xs={12} className="pt-5 pl-lg-5 pr-lg-5 pl-md-3 pr-md-3 aws-card-text" >
                            <Row className="pb-5">
                                <Col>
                                    <h4>
                                        Why move to cloud?
                            ...
                            <span className="vc_sep_line" style={{ borderColor: "rgba(255,255,255,0.2)" }} ></span>
                            <Row className="pt-5 pb-5">
                                <Col>
                                    <Row>
                                        <Col xs={2}>
                                            <FiCheck style={{ border: "1px solid purple", borderRadius: "50%", padding: "5px" }} color="purple" size="42" />
                                        </Col>
                                        <Col>
                    ...
                    <Row className="m-0 pt-5">
                        <Col sm={12} md={4} className="d-flex justify-content-center text-center mt-5">
                        <VisibilitySensor onChange={onChange} once>
                            <div className="text-center">
                                ...
                                <h5 className="pt-4 text-white">Reduced cost of operations</h5>
