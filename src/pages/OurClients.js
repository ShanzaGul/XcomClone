...
function OurClients() {
    ...
    return (
        <div className="ourclients-container" style={{ backgroundColor: "#0b0616" }}>
                    ...
                    <Col>
                        ...
                        <Row style={{ paddingBottom: "8%" }}>
                            <Col className="our-client-margin">
                                <Row>
                                    <Col lg={4} md={12} className="card-margin-top mt-md-5 mt-lg-0">
                                        <CardClient Img={co7} />
                                    </Col>
                                    <Col lg={4} md={12} className="card-margin-top mt-md-5 mt-lg-0">
                                        <CardClient Img={co3} />
                ...
                <Col className="p-0">
                    <Row className="our-client-margin">
                        <Col className="bg-purple contact-col" lg={6} md={12} xs={12} >
                            <Row>
                                <Col>
                                    <img src={icon} style={{ width: "20%", height: "auto" }} alt="img for contact icon"></img>
                                </Col>
                            </Row>
                            <Row className="pt-3"> 
                                <Col>
                                    <h3>Don't know where to start? <br></br>Let's get in touch!</h3>
                        ...
                        <Col lg={6} md={12} xs={12} className="form-col">
                            <Form>
                               <Form.Group>
                                ...
                                <Button type="submit" className="bg-purple" style={{width:"100%"}}>
                                    Submit
                                </Button>
                            </Form>
                        </Col>
            ...
            <Row  style={{marginTop:"5%" , marginLeft:"0px" ,marginRight:"0px" }}>
                <Col className="p-0">
                    <Row className="our-client-margin">
                        <Col lg={3} md={12} xs={12} style={{padding:"5%" , color:"white"}}>
                            <div>
                            <h6>Xcom</h6>
                        ...
                        <Col lg={3} md={12} xs={12} style={{ padding:"5%" , color:"#8639ff"}}>
                        <h6>Services</h6>
                        ...
                        <Col lg={3} md={12} xs={12} style={{padding:"5%" , color:"white"}}>
                            ...
                            <GrLinkedinOption color="#DDDDDD" className="ml-3"></GrLinkedinOption>
            ...
            <Row  style={{marginTop:"2%" , marginLeft:"0px" ,marginRight:"0px" , borderTop:"1px solid purple" }}>
                <Col className="p-0">
                    <Row className="our-client-margin">
